...
for lr in learning_rates:
    for reg in regularization_strengths:
        # 1. Instantiate a new SVM classifier
        svm = LinearSVM()

        # 2. Train the classifier with the current hyperparameters
        ...
        # 5. Store results in the dictionary
        results[(lr, reg)] = (train_accuracy, val_accuracy)

        # 6. Update the best model if the current one is better
